      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
        ...
        <Phone>
          <div style={{
            ...
            <span onClick={() => navigate("/mypage")} style={{ fontSize: 18, color: TEXT_SUB, cursor: "pointer" }}>‹</span>
            <img src={logoUrl} alt="タップミー / TAPME" onClick={() => navigate("/")} style={{ height: 38, objectFit: "contain", cursor: "pointer" }} />
            ...
            <div style={{ padding: "20px 16px 24px" }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ fontSize: 11, color: TEXT_SUB, lineHeight: 1.6 }}>
                  各セクションの「修正する」から編集できます。<br/>
                  プロフィール充実度UPでスカウト率もUP！
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  fontSize: 11, fontWeight: 700, color: NAVY, lineHeight: 1.7,
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <Btn onClick={() => navigate("/mypage")}>マイページに戻る</Btn>
            </div>
          </div>
        </Phone>
      </div>
